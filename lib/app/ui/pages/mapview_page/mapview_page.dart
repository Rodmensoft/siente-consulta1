                  ...
                  children: <Widget>[
                    GoogleMap(
                      ...
                      padding: EdgeInsets.only(
                        top: homeController.isMarkerOpened.value ? 197.sp : 0,
                      ),
                      onTap: (LatLng latLng) {
                        if (homeController.isMarkerOpened.value) {
                          homeController.isMarkerOpened.value = false;
                        }
                      },
                      gestureRecognizers: <
                    ...
                    if (homeController.proyectoMapa != null)
                      Obx(() => Visibility(
                            visible: homeController.isMarkerOpened.value,
                            child: ProyectContainerFigmaVersion(
                              image:
                                  homeController.proyectoMapa!.urlImageProyecto,
                              title:
                                  homeController.proyectoMapa!.nombreproyecto,
                              location: homeController
                                  .proyectoMapa!.localidadproyecto,
                              color:
                                  homeController.proyectoMapa!.colorCategoria,
                              status:
                                  homeController.proyectoMapa!.estadoproyecto,
                              value: homeController.proyectoMapa!.valorproyecto,
                              progress:
                                  homeController.proyectoMapa!.avanceproyecto,
                              semaforo:
                                  homeController.proyectoMapa!.semaforoproyecto,
